...
java -cp ${HOME}/bin/utilities-5.0.39/utilities-5.0.39.jar com.compomics.cli.peptide_mapper.PeptideMapperCLI -p ${EXAMPLES_DIR}/PeptideMapping/yeast.fasta ${EXAMPLES_DIR}/PeptideMapping/yeast-pep-1k.csv results.csv
